...
#pragma warning disable CS8601 // Possible null reference assignment.
        ...
        if (!Uri.TryCreate(blobStorageEndpoint, UriKind.Absolute, out BlobStorageEndpoint))
            throw new ArgumentException($"BlobStorageEndpoint {BlobStorageEndpoint} is not a valid URI.");
...
#pragma warning restore CS8601 // Possible null reference assignment.
    ...
    public readonly Uri BlobStorageEndpoint;
